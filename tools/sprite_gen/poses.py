...
STYLE_PREAMBLE = (
    ...
    "BODY PROPORTIONS -- this is critical, follow it exactly: exaggerated CHIBI "
    "proportions, NOT realistic human proportions. The head is large and rounded, "
    "roughly 1/3 to 2/5 of the character's total height. The body is small and compact "
    "with short, stubby limbs and a small torso. The character should look cute and "
    "toy-like / doll-like, like a classic top-down RPG overworld sprite, never like a "
    "realistically-proportioned person.\n\n"
